...
<%@ page import="java.sql.*,java.io.*,dbconnection.getdb" %>
...
try{
	...
	PreparedStatement ps = con.prepareStatement("SELECT	* FROM OFFENCE WHERE OFFENCE_LOCATION = ? or OFFENCE_DATE = ? or OFFENCE_TYPE = ?");
...
<table class="table">
                            <tr>
                                <th>Offence_Id</th>
                                <th>Offence_Date</th>
                                <th>Offence_Location</th>
                                <th>Offence_Type</th>
                                <th>Offence_Details</th>
                                <th>Offence_Fine Amount</th>
                                <th>Offence_Pay Status</th>
                                <th>Offence_Issuer</th>
                                <th>Driver_Name</th>
                                <th>Driver_Mobile no</th>
                            </tr>
<% while(rs.next()){%>
<tr>
