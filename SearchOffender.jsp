...
<%@ page import="java.sql.*,java.io.*,dbconnection.getdb" %><!-- descriptive tag to import class or jsp page -->
...
%>
                    ...
                    <ul class="navbar-nav mr-auto justify-content-end">
                      ...
                      <!--    <li class="nav-item dropdown active">
                        ...
                        <li class="nav-item active">
                                <a class="nav-link" href="SearchOffeder.jsp">Search</a>
                        </li>
        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                <article>
                <h4>Search For Offense Location</h4>
                <form class="" action="SearchResult.jsp" method="get">
                <div class="form-group"></div>
                <label>Location OR Date OR Offence Type</label>
                <input class="form-control" type="text"  placeholder="Enter the location" aria-label="Search" name="location">

               
                <br>
				<button class="btn btn-primary" type="submit">Search In Database</button>
                </form>
                </article>
