        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <h3>Form</h3>
			<form action="Addbooth" method="get">
                        <fieldset>
                            <legend>To Add New Traffic Circle</legend>
                            <div class="form-group">
                                <label for="exampleInputName">Location</label>
                                <input type="text" class="form-control" id="exampleInputName" name="loc">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputName">Crossings Under Circle</label>
                                <textarea class="form-control" id="exampleInputName" rows="3" name="cross"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputName">Circle Incharge</label>
                                <input type="text" class="form-control" id="exampleInputName" name="incharge">
                            </div>
