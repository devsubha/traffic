                      ...
                      <!--    <li class="nav-item dropdown active">
                        ...
                        <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><% out.print("hello! "); %><span id="iq"><% out.print(s); %></span> <span class="sr-only">(current)</span></a>
                       			<div class="dropdown-menu navbar-dark bg-primary">
                                          <a class="dropdown-item" href="examples.html">Profile</a>
                                          <a class="dropdown-item" href="three-column.html">Logout</a>
                                </div>
                        </li>
        ...
        <main class="container">
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <h3>Form</h3>
			<form action="Addoffence" method="get">
                        <fieldset>
                            <legend>To Add Offence</legend>
                            <div class="form-group">
                                <label for="exampleInputName">Offence ID</label>
                                <input type="text" class="form-control" id="exampleInputName" name="id">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputName">Offence Type</label>
                                <input type="text" class="form-control" id="exampleInputName" name="otype">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputName">Offence Details</label>
                                <textarea class="form-control" id="exampleInputName" rows="3" name="odetails"></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                <label for="exampleInputName">Offence Fine Amount</label>
                                <input type="text" class="form-control" id="exampleInputName" name="ofineamt">
                            </div>

                            <div class="form-group">
                                <label for="exampleInputMessage">Offence Repeat Amount</label>
                                 <input type="text" class="form-control" id="exampleInputMessage" name="orepeatamt">
                            </div>

                           <!--  <div class="form-group">
                                <label for="exampleInputName">Fine Amount</label>
